 ...
 **Listar Citas**
  - **URL:** `/adoptionSystem/v1/appointment/getAppointments`
  - **Método:** `GET`

 **Actualizar Cita**
  - **URL:** `/adoptionSystem/v1/appointment/updateAppointment/:eid`
  - **Método:** `PATCH`
  - **Cuerpo:**
    ```json
      {
 ...
 **Cancelar Cita**
  - **URL:** `/adoptionSystem/v1/appointment/cancelAppointment/:eid`
  - **Método:** `PATCH`
